...
pragma Elaborate_All
  (OpenToken.Recognizer.Character_Set, OpenToken.Recognizer.End_Of_File,
   OpenToken.Recognizer.Keyword, OpenToken.Recognizer.Nothing,
   OpenToken.Recognizer.Separator, OpenToken.Recognizer.String);
