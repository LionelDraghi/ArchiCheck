...
package body Acc.Rules.Parser is
   ...
   --                            Prefix : in String  := "Rules_Parser") renames Acc.IO.Put_Debug_Line;
   --     procedure Put_Debug (Msg    : in String  := "";
   --                          Debug  : in Boolean := True;
   --                          Prefix : in String  := "Rules_Parser") renames Acc.IO.Put_Debug;
