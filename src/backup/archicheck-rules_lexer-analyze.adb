...
with Archicheck.Rules_Lexer;
--use type OpenToken.Token.Sequence.Instance;
--use type OpenToken.Token.Selection.Instance;

--use Lexer;

procedure Archicheck.Rules_Lexer.Analyze is
   File : Ada.Text_IO.File_Type;
   File_Name : constant String := Ada.Command_Line.Argument (1);

begin
   Sentence_List.all := OpenToken.Token.List.Get
     (Element => Lexer.Sentence, Separator => Lexer.EoL_T);
...
end Archicheck.Rules_Lexer.Analyze;
