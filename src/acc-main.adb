...
with Acc.IO;
with Acc.Lang;
with Acc.Lang.Initialize;
with Acc.Rules.Check;
with Acc.Rules.Parser;
with Acc.Rules.Check_Unrelated_Rules_Units;
with Acc.Rules.Dump_Unrelated_Compilation_Units;
with Acc.Settings;
with Acc.Sources;                      use Acc.Sources;
with Acc.Units;

with Ada.Command_Line;

procedure Acc.Main is
